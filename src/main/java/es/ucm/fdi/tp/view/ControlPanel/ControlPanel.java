...
public class ControlPanel<S extends GameState<S, A>, A extends GameAction<S, A>> extends GUIView<S, A>
	...
	/**
	 * Muestra un mensaje para advertirle al jugador de que se va a cerrar el
	 * juego.
	 * 
	...
	/**
	 * Notifica a los observadores del Control Panel de que hay que realizar una
	 * nueva acción automática (Jugador Random o Smart).
	 * 
	 * @param playerType
	 *            tipo de jugador, Random o Smart.
	 */
	...
	// for (ControlPanelObservable controlPanelObservable :
	// controlPanelObservables) {
	...
	// * @param isThinking Booleano que indica si el jugador Smart está o no
	// pensando.
	// */
