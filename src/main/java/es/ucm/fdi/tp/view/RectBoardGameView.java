...
public abstract class RectBoardGameView<S extends GameState<S, A>, A extends GameAction<S, A>> extends GameView {
    ...
    protected abstract int getNumCols(); //devuelve el número de filas del tablero.
